...
var logHandler = require('./log-handler');
logHandler.setExtra('nolimit.js', '1.2.74');
...
var nolimit = {
     ...
     * @param {Boolean} [options.hideExitButton=false] set to true to  to control closing of mobile games from outside of game area.
     *
     * @example
     * nolimit.init({
