...
var UAParser=require("ua-parser-js"),uaParser=new UAParser,ua=uaParser.getResult(),SESSION_KEY="nolimit.js.log.session",URL="https://gamelog.nolimitcity.com/",session=handleSession(),extras={};function uuidv4(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(e){var r=16*Math.random()|0;return("x"===e?r:3&r|8).toString(16)})}function handleSession(){var e=sessionStorage.getItem(SESSION_KEY)||uuidv4();return sessionStorage.setItem(SESSION_KEY,e),e}function sendLog(e,r){var s=new XMLHttpRequest;s.open("POST",URL,!0),s.setRequestHeader("Content-Type","application/json"),s.onload=function(){if(s.status>=200&&s.status<400)try{var o=JSON.parse(s.responseText);console.log("Logger response:",o)}catch(s){console.warn("Failed to send log:",s.message,e,r,s)}else console.warn("Error from server:",s.status,s.statusText,e,r)},s.onerror=function(){console.warn("Logger error:",s.status,s.statusText,e,r)};var o=uaParser.getDevice(),n={event:e,session:session,browser:ua.browser.name+" "+ua.browser.version,os:ua.os.name+" "+ua.os.version,vendor:o.vendor,model:o.model};for(var a in extras)n[a]=extras[a];var t=uuidv4();n.data=r;var i={key:t,body:n};console.log("Logging payload:",i),s.send(JSON.stringify(i))}var logHandler={sendError:function(e){var r=e.message||e;"Script error."!==r&&(e.code&&(r=r+" ("+e.code+")"),e.filename&&e.lineno&&(r=r+" @ "+e.filename+" line:"+e.lineno),sendLog("ERROR",{message:r}))},setExtra:function(e,r){extras[e]=r},setExtras:function(e){for(var r in e)this.setExtra(r,e[r])}};window.addEventListener("error",function(e){console.warn(e.message,e),logHandler.sendError(e)}),module.exports=logHandler;
