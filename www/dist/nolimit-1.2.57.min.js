...
var BASE_URL="https://nolimitjs.nolimitcdn.com/img",FINGER=BASE_URL+"/finger.svg",ARROW=BASE_URL+"/arrow.svg",fullscreen=!1;function preventResize(e){1!==e.scale&&(e.preventDefault(),e.stopPropagation())}function getOrientation(){return window.innerHeight>window.innerWidth?"portrait":"landscape"}function addCss(){var e=document.createElement("style");document.head.appendChild(e),e.appendChild(document.createTextNode(require("./ios-fullscreen.css")))}var iosFullscreen={init:function(e){var n=navigator.userAgent.toLowerCase();-1!==n.indexOf("safari")&&n.indexOf("chrome"),window.top,window.self;return void 0}};module.exports=iosFullscreen;
